...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        // draw over everything without taking aplha into consideration
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for node in tappedNode {
            ...
            if node.name == "charFriend" {
                ...
                if let particles = SKEmitterNode(fileNamed: "sparkBad.sks") {
    ...
    func createEnemy() {
        ...
        if numRounds >= 30 {
            ...
            run(SKAction.playSoundFileNamed("sound.m4a", waitForCompletion: false))
            return
        }
